let inputWrapp = document.querySelector(".main__input-group");
let inputEl = inputWrapp.querySelector(".main__input");
let inputPlaceholder = inputWrapp.querySelector(".main__label");
let buttonEl = document.querySelector(".main__btn");
let buttonRepeatEl = document.querySelector(".square__button");
let square = document.querySelector(".main__square");
let month = "";
let year = "";
let day = "";
...
buttonEl.onclick = () => {
  if (inputEl.value.replace(/\D/g, "").length != 8) {
    ...
    itemArr[5].querySelector("span").innerHTML =
      itemArr[2].querySelector("span").innerHTML.length +
      itemArr[3].querySelector("span").innerHTML.length +
      itemArr[4].querySelector("span").innerHTML.length;
    itemArr[9].querySelector("span").innerHTML =
      itemArr[6].querySelector("span").innerHTML.length +
      itemArr[7].querySelector("span").innerHTML.length +
      itemArr[8].querySelector("span").innerHTML.length;
    itemArr[13].querySelector("span").innerHTML =
      itemArr[10].querySelector("span").innerHTML.length +
      itemArr[11].querySelector("span").innerHTML.length +
      itemArr[12].querySelector("span").innerHTML.length;
    itemArr[14].querySelector("span").innerHTML =
      itemArr[2].querySelector("span").innerHTML.length +
      itemArr[6].querySelector("span").innerHTML.length +
      itemArr[10].querySelector("span").innerHTML.length;
    itemArr[15].querySelector("span").innerHTML =
      itemArr[3].querySelector("span").innerHTML.length +
      itemArr[7].querySelector("span").innerHTML.length +
      itemArr[11].querySelector("span").innerHTML.length;
    itemArr[16].querySelector("span").innerHTML =
      itemArr[4].querySelector("span").innerHTML.length +
      itemArr[8].querySelector("span").innerHTML.length +
      itemArr[12].querySelector("span").innerHTML.length;

    itemArr[17].querySelector("span").innerHTML =
      itemArr[2].querySelector("span").innerHTML.length +
      itemArr[7].querySelector("span").innerHTML.length +
      itemArr[12].querySelector("span").innerHTML.length;
    itemArr[1].querySelector("span").innerHTML =
      itemArr[10].querySelector("span").innerHTML.length +
      itemArr[7].querySelector("span").innerHTML.length +
      itemArr[4].querySelector("span").innerHTML.length;
    ...
    if (document.querySelector(".german") != undefined) {
      itemArr[0].querySelectorAll("p")[1].innerHTML =
        "Geburtsdatum " + inputEl.value;
      itemArr[0].querySelectorAll("p")[2].innerHTML =
        "Zusatzzahlen " + num1 + " " + num2 + " " + num3 + " " + num4;
      document.querySelector(".summtext").innerHTML =
        itemArr[2].querySelector("span").innerHTML +
        "/" +
        itemArr[6].querySelector("span").innerHTML +
        "/" +
        itemArr[10].querySelector("span").innerHTML +
        "/" +
        itemArr[3].querySelector("span").innerHTML +
        "/" +
        itemArr[7].querySelector("span").innerHTML +
        "/" +
        itemArr[11].querySelector("span").innerHTML +
        "/" +
        itemArr[4].querySelector("span").innerHTML +
        "/" +
        itemArr[8].querySelector("span").innerHTML +
        "/" +
        itemArr[12].querySelector("span").innerHTML +
        "/lz" +
        itemArr[0].querySelector("span").innerHTML;
    } else {
      itemArr[0].querySelectorAll("p")[1].innerHTML =
        "Дата рождения " + inputEl.value;
      itemArr[0].querySelectorAll("p")[2].innerHTML =
        "Доп числа " + num1 + " " + num2 + " " + num3 + " " + num4;
      document.querySelector(".summtext").innerHTML =
        itemArr[2].querySelector("span").innerHTML +
        "/" +
        itemArr[6].querySelector("span").innerHTML +
